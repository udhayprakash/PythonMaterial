...
binexp = lambda n: n**2 + 2 * n - 6  # noqa: E731
...
h = lambda fn, ln: f"Hello {fn} {ln} !!!"  # noqa: E731
...
tevl = lambda num: "even" if num % 2 == 0 else "odd"  # noqa: E731
...
get_index_l = lambda gvn_t, sv: gvn_t.index(sv)  # noqa: E731
...
# ----- Lambda with no args
myfunc = lambda: "hello! no args given"  # noqa: E731
print(f"{myfunc() = }")
print(f"{myfunc() = }")
print()

# ----- Lambda with args not used
myfunc = lambda name: "hello! My name is name"  # noqa: E731
print(f'{myfunc("Udhay") = }')
print(f'{myfunc("Neha") = }')
print()

# ----- Lambda with args used
myfunc = lambda name: f"hello! My name is {name}"  # noqa: E731
print(f'{myfunc("Udhay") = }')
print(f'{myfunc("Neha") = }')
