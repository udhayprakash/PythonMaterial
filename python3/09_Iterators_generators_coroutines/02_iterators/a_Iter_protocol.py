...
# print("vegetables_iter[1]", vegetables_iter[1]) # TypeError: 'list_iterator' object is not subscriptable
...
print(veto_countries_iter.__next__())
print(callable(veto_countries_iter.__next__))
