...
class TrafficLightSimulator:
    def __init__(self):
        ...
        self.green_signal = turtle.Turtle()  # Create a turtle, assign to self.green_signal
    ...
    def draw_housing(self):
        ...
        self.green_signal.forward(80)  # Tell self.green_signal to move forward by 80 units
        self.green_signal.left(90)  # Tell self.green_signal to turn left by 90 degrees
        self.green_signal.forward(200)
        self.green_signal.circle(40, 180)  # Tell self.green_signal to draw a semi-circle
        self.green_signal.forward(200)
    ...
    def advance_state_machine(self):
        ...
        if self.state_num == 0:  # Transition from state 0 to state 1
            ...
            self.wn.ontimer(self.advance_state_machine, 3000)  # set the timer to explode in 3 sec
            self.state_num = 1
