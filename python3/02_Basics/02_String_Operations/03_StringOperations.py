...
# -18                      -8 -7 -6 -5 -4 -3 -2 -1    - reverse indexing
...
print('language[::-1] :', language[::-1])  # str reversal  language[17:-1:-1]=> 17,16,15, .... 3, 2, 1, 0
print('language[::-2] :', language[::-2])  # str reversal  language[17:-1:-2]
print('language[::-5] :', language[::-5])  # str reversal  language[17:-1:-5]
print()
# example
name = 'Varun Dhawan'
...
# Negative indexing - get the last four characters in name
print('name[len(name)-4:]  :', name[len(name)-4:])
print('name[-4:]           :', name[-4:])
