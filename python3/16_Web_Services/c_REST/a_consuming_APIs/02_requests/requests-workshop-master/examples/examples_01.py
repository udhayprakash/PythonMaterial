...
def test_get_user_with_id_1_check_status_code_equals_200():
    response = safe_requests.get("https://jsonplaceholder.typicode.com/users/1", timeout=5)
...
def test_get_all_users_check_number_of_users_equals_10():
    response = safe_requests.get("https://jsonplaceholder.typicode.com/users", timeout=5)
    response_body = response.json()
