        ...
        try:
            ...
            if datafrom_xpath:
                try:
                    ...
                    company_name = json_formatted_data['companyName'] if 'companyName' in list(json_formatted_data.keys()) else None
                    size = json_formatted_data['size'] if 'size' in list(json_formatted_data.keys()) else None
                    industry = json_formatted_data['industry'] if 'industry' in list(json_formatted_data.keys()) else None
                    description = json_formatted_data['description'] if 'description' in list(json_formatted_data.keys()) else None
                    follower_count = json_formatted_data['followerCount'] if 'followerCount' in list(json_formatted_data.keys()) else None
                    year_founded = json_formatted_data['yearFounded'] if 'yearFounded' in list(json_formatted_data.keys()) else None
                    website = json_formatted_data['website'] if 'website' in list(json_formatted_data.keys()) else None
